...
const TIMELINE: TimelineEntry[] = [
  {
    ...
    closedSource: [
      { name: 'AutoLab', description: 'Autonomous agentic loop for Lab-in-the-Loop experimental workflows.', tags: ['python', 'aws', 'claude api'], status: 'ongoing' },
      { name: 'EpicShelter', description: 'Large-scale protein sequence embedding and retrieval pipeline.', tags: ['python', 'pytorch', 'aws'], status: 'ongoing' },
    ],
  },
  {
